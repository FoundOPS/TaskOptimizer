 ...
 * September 28, 2006:  - Not topmost anymore. Now only topmost for the application.  This avoids hiding other
 ...
 * February 8, 2007:    - Enhancement (thanks to Quentin Pouplard): Thread safe.  Show, Fade and Hide methods 
 *                        can now be called from any threads.
...
namespace MT
{
    ...
    public partial class CurtainForm : Form
    {
        ...
        /// <summary>
        /// Show the curtain without owner window.  Thread safe.
        /// </summary>
        ...
        /// <summary>
        /// Show the curtain over this window or control. Thread safe.
        /// </summary>        
        ...
        /// <summary>
        /// Hide the curtain using this animation.  Thread safe.
        /// </summary>                
